...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            // Global
            ['site_title', 'Samuraiblue'],
            ['site_title_full', 'Samuraiblue'],
            ...
            ['site_information', 'Samuraiblue'],

            ['site_phone', '01-5907931'],
            ['site_email', 'samuraiblue@gmail.com'],
            ['site_location', 'Kathmandu, Nepal'],
            ['site_location_url', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d440.57915189381816!2d85.32309917747837!3d27.668628534399804!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb193be21aea5b%3A0xaa83ef792abf1f63!2ssamuraiblue%20Educare%20Consultancy!5e1!3m2!1sen!2snp!4v1744195769373!5m2!1sen!2snp'],
            ['site_mail', 'mail.samuraiblue.com.np'],
            ['site_url', '/'],

            ['site_copyright', 'samuraiblue'],
            ...
            ['contact_description', 'samuraiblue'],

            ['contact_location', 'Chitwan, Kathmandu'],
            ['contact_email', 'info@samuraiblue.com'],
            ...
            ['contact_seo_title', 'samuraiblue'],
            ['contact_seo_description', 'samuraiblue'],
            ['contact_seo_keywords', 'samuraiblue'],
            ['contact_seo_schema', 'samuraiblue'],
            ...
            ['homepage_title', 'Under the Stars: Your Career Journey Begins'],
            ['homepage_small_title', 'Explore career opportunities, connect with top employers, and take the next step in your professional journey with confidence.'],
            ['homepage_image', null],
            ['homepage_description', 'Under the Stars is a modern job portal designed to help job seekers discover opportunities, build meaningful careers, and connect with organizations that value growth, learning, and success.'],
            ...
            ['homepage_seo_title', 'samuraiblue'],
            ['homepage_seo_keywords', 'samuraiblue'],
            ['homepage_meta_description', 'samuraiblue'],
            ['homepage_seo_schema', 'samuraiblue'],
