            ...
            <div class="col-lg-6 content-column">
              <div class="inner-column right-column">
                <div class="sec-title mb-30">
                  ...
                  <p class="text wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">{{ $settings['contact_description'] }}</p>
                </div>
                <form action="{{ route('frontend.contact.submit') }}" method="POST">
                  ...
                  <div class="type-feild">
                    ...
                    <input type="text" name="email" class="" id="email" placeholder="Email Address*" />
                    @error('email')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
                  <div class="type-feild">
                    ...
                    <textarea name="message" class="" id="message" placeholder="Enter Your Messege here"></textarea>
                    @error('message')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>

                  <button type="submit" class="theme-btn btn-style-one rounded-0">Submit Now</button>
                </form>
              </div>
            </div>
          </div>
